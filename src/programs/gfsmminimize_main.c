/*
   ...
   Copyright (C) 2011 by Bryan Jurish <moocow.bovine@gmail.com>
...
#include "gfsmminimize_cmdparser.h"

/*--------------------------------------------------------------------------
 * Globals
 *--------------------------------------------------------------------------*/
char *progname = "gfsmminimize";
...
int main (int argc, char **argv)
{
  ...
  //-- hack 'is_deterministic' flag?
  if (args.deterministic_flag) fsm->flags.is_deterministic=TRUE;

  //-- minimize
  gfsm_automaton_minimize_full(fsm, !args.epsilon_flag);
