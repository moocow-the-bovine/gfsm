/* -*- Mode: C -*-
 *
 * File: gfsmminimize_cmdparser.c
 * Description: Code for command-line parser struct gengetopt_args_info.
 *
 * File autogenerated by optgen.perl version 0.07
 * generated with the following command:
 * /usr/local/bin/optgen.perl -u -l --no-handle-rcfile --nopod -F gfsmminimize_cmdparser gfsmminimize.gog
 *
...
{
  printf("gfsmminimize (%s %s) by Bryan Jurish <moocow.bovine@gmail.com>\n", PACKAGE, VERSION);
}
...
cmdline_parser_print_help (void)
{
  ...
  printf("\n");
  printf("Purpose:\n");
  printf("  Minimize finite state machines as (pair)-acceptors\n");
  printf("\n");
  ...
  printf("   -D       --deterministic   Assume input automaton is deterministic.\n");
  printf("   -E       --epsilon         Skip epsilon removal.\n");
...
{
  args_info->deterministic_flag = 0; 
  args_info->epsilon_flag = 0; 
...
cmdline_parser (int argc, char * const *argv, struct gengetopt_args_info *args_info)
{
  ...
  args_info->deterministic_given = 0;
  ...
  switch (oshort)
    {
      case 'h':	 /* Print help and exit. */
        ...
        case 'D':	 /* Assume input automaton is deterministic. */
          if (args_info->deterministic_given) {
            fprintf(stderr, "%s: `--deterministic' (`-D') option given more than once\n", PROGRAM);
          }
          args_info->deterministic_given++;
         if (args_info->deterministic_given <= 1)
           args_info->deterministic_flag = !(args_info->deterministic_flag);
          break;
        
        case 'E':	 /* Skip epsilon removal. */
          if (args_info->epsilon_given) {
            fprintf(stderr, "%s: `--epsilon' (`-E') option given more than once\n", PROGRAM);
          }
          args_info->epsilon_given++;
         if (args_info->epsilon_given <= 1)
           args_info->epsilon_flag = !(args_info->epsilon_flag);
          break;
        ...
        /* Print help and exit. */
          ...
          else if (strcmp(olong, "deterministic") == 0) {
            if (args_info->deterministic_given) {
              fprintf(stderr, "%s: `--deterministic' (`-D') option given more than once\n", PROGRAM);
            }
            args_info->deterministic_given++;
          ...
          else if (strcmp(olong, "epsilon") == 0) {
            if (args_info->epsilon_given) {
              fprintf(stderr, "%s: `--epsilon' (`-E') option given more than once\n", PROGRAM);
            }
            args_info->epsilon_given++;
