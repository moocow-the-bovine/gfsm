/* -*- Mode: C -*-
 *
 * File: gfsmarcuniq_cmdparser.c
 * Description: Code for command-line parser struct gengetopt_args_info.
 *
 * File autogenerated by optgen.perl version 0.06
 * generated with the following command:
 * /usr/local/bin/optgen.perl -u -l --no-handle-rcfile --nopod -F gfsmarcuniq_cmdparser gfsmarcuniq.gog
 *
...
{
  printf("gfsmarcuniq (%s %s) by Bryan Jurish <moocow.bovine@gmail.com>\n", PACKAGE, VERSION);
}
...
cmdline_parser_print_help (void)
{
  ...
  printf("\n");
  printf("Purpose:\n");
  printf("  Collect weights on otherwise indistinguishable arcs of a gfsm automaton\n");
  printf("\n");
