/* -*- Mode: C -*-
 *
 * File: gfsmcompact_cmdparser.c
 * Description: Code for command-line parser struct gengetopt_args_info.
 *
 * File autogenerated by optgen.perl version 0.07
 * generated with the following command:
 * /usr/local/bin/optgen.perl -u -l --no-handle-rcfile --nopod -F gfsmcompact_cmdparser gfsmcompact.gog
 *
...
{
  printf("gfsmcompact (%s %s) by Bryan Jurish <moocow.bovine@gmail.com>\n", PACKAGE, VERSION);
}
...
cmdline_parser_print_help (void)
{
  ...
  printf("\n");
  printf("Purpose:\n");
  printf("  Heuristically compact finite state machines\n");
  printf("\n");
