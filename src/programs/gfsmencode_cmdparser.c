...
{
  printf("gfsmencode (%s %s) by Bryan Jurish <moocow.bovine@gmail.com>\n", PACKAGE, VERSION);
}
...
cmdline_parser_print_help (void)
{
  ...
  printf("\n");
  printf("Purpose:\n");
  printf("  Encode weights and/or label-pairs of (weighted) finite state machines\n");
  printf("\n");
  
  printf("Usage: %s [OPTIONS]... BINFILE KEYFILE\n", "gfsmencode");
  
  printf("\n");
  printf(" Arguments:\n");
  printf("   BINFILE  Stored binary gfsm file to be encoded\n");
  printf("   KEYFILE  Binary gfsm representing encoding key\n");
  ...
  switch (oshort)
    {
      case 'h':	 /* Print help and exit. */
        ...
        case 'd':	 /* Decode an encoded automaton (default: encode) */
        ...
        case 'c':	 /* Encode/decode costs (weights); encodes as unweighted automaton */
          ...
          args_info->costs_given++;
         if (args_info->costs_given <= 1)
