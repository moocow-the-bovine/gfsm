...
/*======================================================================
 * Methods: gfsmWStateSet: Constructors etc.
 */
//-- inlined

/*======================================================================
 * Methods: gfsmWStateSet: Accessors
 */

//--------------------------------------------------------------
static gboolean gfsm_wqset_to_list_foreach_(gpointer key, gpointer value, gpointer data)
{
  gfsmWState *wq = g_new(gfsmWState,1);
}

//--------------------------------------------------------------
gfsmWStateList *gfsm_wqset_to_list(gfsmWStateSet *wqset)
{
  gfsmWStateList *wql = NULL;
  gfsm_weightmap_foreach(wqset, (GTraverseFunc)gfsm_wqset_to_list_foreach_, &wql);
  return wql;
}
