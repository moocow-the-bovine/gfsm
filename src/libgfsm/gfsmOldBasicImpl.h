...
/*=============================================================================*\
 * File: gfsmOldBasicImpl.h
 * Author: Bryan Jurish <moocow@ling.uni-potsdam.de>
 * Description: finite state machine library: automata implementation: basic (old)
 *
...
/** \file gfsmOldBasicImpl.h
 *  \brief Automaton definitions and low-level access, backwards-compatible implementation
 */

#ifndef _GFSM_OLD_BASIC_IMPL_H
#define _GFSM_OLD_BASIC_IMPL_H
